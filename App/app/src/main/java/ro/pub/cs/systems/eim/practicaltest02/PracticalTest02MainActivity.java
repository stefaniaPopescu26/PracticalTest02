...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetCurrencyInfoButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            clientThread = new ClientThread(clientAddress, Integer.parseInt(clientPort), currencyType, currencyTextView);
            clientThread.start();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCurrencyInfoButton = (Button)findViewById(R.id.get_currency_info_button);
        getCurrencyInfoButton.setOnClickListener(getCurrencyInfoButtonClickListener);
